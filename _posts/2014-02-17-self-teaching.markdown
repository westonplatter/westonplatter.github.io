...
First, I start by comparing new concepts with other ideas and hopefully make an analogy. If I can get the digestion process into an analytically comparative operation I'm 3x more effective than if I'm straight up learning new material. Second, I take the simpler aspects of the new concept and create a visual illustration. Again, I'm 3x more effective with knowledge if I have create a visual representation. Up until now, all the knowledge and understanding I've process is devoid of state or order based dependencies. Third step is to introduce an order list of how the new concept can be explained by building the concept from no previous knowledge.
